...
const LumberingTool = () => {
  ...
  const mapResultData = (data) => {
    ...
    return {
      ...
      "부드러운 목재": data.고급 || 0,
      "튼튼한 목재": data.희귀 || 0,
      "아비도스 목재": data.희귀 || 0, // 희귀 항목을 아비도스 목재에도 매핑
    };
  };
...
const handleSaveToLocalStorage = () => {
  ...
  const updatedData = {
    ...
    ...updatedLumberingData, // 벌목 데이터 덮어쓰기
  };
  ...
  return (
    <div className="LifeTool">
      <header>
        <h1>
          벌목 도구 계산기&nbsp;
          <span className="h1-sub">gld-2</span>
        </h1>
        <h5>※ 미겜 보라 비율 = 미니게임, 나무차기를 영웅채집물에 사용한 비율 (기본 15%)    
          <br/> &nbsp; &nbsp;&nbsp;
        </h5>
      </header>
      ...
      <div className="Gauge-container">
        <h2>도구 성능 <span className="subtext">(적용하기 → 획득량 박스 클릭)</span> </h2>
